...
class LinkTagsToItem(MethodView):
    ...
    def delete(self, item_id, tag_id):
        ...
        try:
            ...
            abort(500, message="An error occuredwhile inserting the tag.")
...
class Tag(MethodView):
    ...
    @blp.response(
        202, 
        description="Deletes a tagif no item is tagged with it.", 
    ...
    def delete(self, tag_id):
        ...
        abort(400, 
              message="Could not delete tag. Make sure tag is not associated with \
                any items, then try again.")